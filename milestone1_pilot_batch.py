...
def build_dynamic_taxonomy(titles):
    ...
    # Enhance with frequent terms and NLP
...
def group_similar_titles(titles, threshold=0.2):
    ...
    for idx, label in enumerate(clustering.labels_):
        if label != -1:  # -1 indicates noise (ungrouped)
...
# Process pilot batch
def process_pilot_batch(input_file, pilot_size=1500, output_file='pilot_batch.xlsx'):
    logging.info("Milestone 1: Processing Pilot Batch...")
...
if __name__ == "__main__":
    ...
    process_pilot_batch(input_file)